    ...
    <div id="header">
      <Navbar {...args}> 
        <NavbarBrand href="/" className='d-flex align-items-center'>
          ...
          />
          <div>
            <p className='title mb-1 fw-bold'>Elif Helin ÇARBOĞA</p>
            <p className='subtitle mb-1'>Developer</p>
            <div>
              <a className='pe-1' style={{color: 'inherit'}} target='_blank' aria-label='linkedin profile link' href="https://www.linkedin.com/in/elif-helin-%C3%A7arbo%C4%9Fa-12bba320a/">
              ...
              <a className='ps-1 pe-1' style={{color: 'inherit'}} target='_blank' aria-label='github profile link' href="https://github.com/elifhelincarboga">
              ...
              <a className='ps-1' style={{color: 'inherit'}} target='_blank' aria-label='hackerrank profile link' href="https://www.hackerrank.com/elifhelincarboga">
